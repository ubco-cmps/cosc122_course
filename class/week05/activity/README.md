...
In this lecture activity, you will be making some clocks and then improving upon the character you made in the last lecture activity.

- Details of [Task1.md](Task1.md).
- Details of [Task2.md](Task2.md).
- Details of [Task3.md](Task3.md).
- Details of [Task4.md](Task4.md).
- Details of [Task5.md](Task5.md).
